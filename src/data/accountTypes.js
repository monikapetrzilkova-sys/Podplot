...
export const BUSINESS_SUBTYPES = {
  ...
  mobilni: {
    ...
    hint: "Bez stálé pobočky — jezdíš za zákazníky. Účet patří jednomu člověku (IČO). V katalogu se ukáže krátký název služby.",
    nameLabel: "Název v katalogu",
    namePlaceholder: "např. Účetnictví",
...
export const ACCOUNT_TYPES = {
  ...
  urad: {
    ...
    icon: "🏛️",
    role: "urad",
    hint: "Obecní nebo městský úřad z katalogu podle PSČ. Jen oficiální e-mail obce; spravovat může víc lidí.",
  ...
  podnik: {
    ...
    icon: "🏪",
    role: "podnik",
    hint: "Ověření přes IČO v ARES. Pobočku může spravovat víc lidí; mobilní služba patří jednomu člověku.",
