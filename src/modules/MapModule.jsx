      ...
      <div className="pp-map-module-root flex flex-col flex-1 min-h-0 overflow-hidden">
        {showMap ? (
          <div className="pp-map-module-viewport relative flex flex-col flex-1 min-h-0 overflow-hidden">
            ...
            {placesLoading ? (
              <div
                className="pp-map-status-overlay absolute top-2 left-2 right-2 z-[4] px-2.5 py-2 rounded-lg border border-[#C5DDD4] bg-[#F1F6F5]/95 text-[#1B4D3E] flex items-start gap-2 pointer-events-none"
                role="status"
                aria-live="polite"
              >
                <span
