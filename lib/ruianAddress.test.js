...
describe("splitStreetAndHouseNumber", () => {
  it("splits a street name and číslo popisné", () => {
    assert.deepEqual(splitStreetAndHouseNumber("Platanová 1568"), {
      street: "Platanová",
      houseNumber: "1568",
    });
    assert.deepEqual(splitStreetAndHouseNumber("Budějovická 477/34"), {
      street: "Budějovická",
      houseNumber: "477/34",
    });
    assert.deepEqual(splitStreetAndHouseNumber("Příčná I."), {
      street: "Příčná I.",
      houseNumber: "",
    });
    assert.deepEqual(splitStreetAndHouseNumber("Platanová"), {
      street: "Platanová",
      houseNumber: "",
    });
  });
