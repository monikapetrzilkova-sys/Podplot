...
const GUIDE_CATEGORY_FETCH = {
  vse: {
    ...
    // Doplní místa, která Nearby type rankuje nízko (stavebniny, bistra, zahradnictví)
    textQueries: ["stavebniny", "zahradnictví", "bistro", "hobby market"],
    keywords: ["stavebniny", "zahradnictví"],
    pages: 2,
    deepTypes: ["restaurant", "meal_takeaway", "hardware_store"],
  },
  zdravi: {
  ...
  gastro: {
    ...
    textQueries: ["restaurace", "sushi", "pizza", "kebab", "bistro", "kavárna", "bufet"],
    pages: 2,
  ...
  obchody: {
    ...
    keywords: ["stavebniny", "zahradnictví", "hobby"],
    pages: 2,
    deepTypes: ["hardware_store", "home_improvement_store"],
  },
  sluzby: {
