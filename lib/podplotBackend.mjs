 ...
 * „vse“ = rychlý přehled (1 stránka, bez text search).
 * Kategorie = hlubší fetch (paralelně, max 2 stránky + české dotazy).
 */
const GUIDE_CATEGORY_FETCH = {
  vse: {
    // Štíhlý přehled — detail dožene výběr kategorie
    types: [
      "pharmacy",
      "dentist",
      "doctor",
...
const NEARBY_CACHE_VERSION = 10;
/** Max současných Nearby / Text Search volání (Google quota + latence). */
const PLACES_FETCH_CONCURRENCY = 8;
