...
const GUIDE_CATEGORY_FETCH = {
  ...
  gastro: {
    ...
    textQueries: ["restaurace", "pizza", "kebab", "bistro", "kavárna"],
    pages: 2,
  ...
  obchody: {
    ...
    textQueries: ["stavebniny", "zahradnictví", "hobby market", "drogerie"],
    keywords: ["stavebniny", "zahradnictví"],
    pages: 2,
    deepTypes: ["hardware_store"],
  },
  sluzby: {
...
/** Názvy bez užitečného Google type (typicky jen establishment) — hřiště, stavebniny, zahradnictví… */
const GUIDE_NAME_HINT_RE =
  /hřišt|hrist|dětsk[ée]\s*hři|playground|park\b|hřbitov|hrbitov|kostel|kaple|naučn|stezka|rybník|rybnik|vodopád|vodopad|\bles\b|louka|zahradnict|zahradnictví|stavebnin|hobby\s*market|\bdek\b|izomat|obi\b|bauhaus|buf[áa]č|bufac|bistro|street\s*food|sportovišt|koupališt|plovárn/i;
